const endpoint = 'https://hardtienda.onrender.com/productos'
...
//   </p>
//   <div class="d-flex ms-auto">
//     <a href="#prodEditar" onClick="editar(${datos.id})" class="btn btn-outline-warning me-2 edit">
//       <i class="bi bi-pencil"></i>
//     </a>
//     <a class="btn btn-outline-danger" onClick="eliminar(${datos.id})" type="submit">
//       <i class="bi bi-trash"></i>
//     </a>
//   </div>
// </div>
